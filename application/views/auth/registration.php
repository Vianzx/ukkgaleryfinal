                    ...
                    <div class="pt-4 pb-4 pl-5 pr-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="name" name="nama_lengkap" value="<?= set_value('nama_lengkap'); ?>" placeholder="Full name">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="alamat" name="alamat" value="<?= set_value('alamat'); ?>" placeholder="Address">
